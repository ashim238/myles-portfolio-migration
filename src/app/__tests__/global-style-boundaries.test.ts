...
const expectedImports = [
  ...
  '@import "./styles/myles-97-now-playing.css";',
  '@import "./styles/myles-97-secondary.css";',
  '@import "./styles/reader-mode.css";',
  '@import "./styles/reader-evidence.css";',
...
const sections = [
  ...
  ["styles/myles-97-now-playing.css", ".now-playing-program {"],
  ...
  ["styles/reader-evidence.css", "Reader evidence state labels"],
  ...
  ["styles/myles-98-paper-contrast.css", "Paper-backed Myles 98 surfaces"],
  ["styles/accessibility-preferences.css", "Preference-specific chrome corrections"],
] as const;
