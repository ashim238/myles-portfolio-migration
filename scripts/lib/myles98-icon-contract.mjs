...
export const APPROVED_ICON_METADATA = freezeMetadata({
  ...
  "fresh-greens": { group: "projects", tiers: { "16": "Compact GPS navigator with a routed map screen and lower control", "24": "Beveled GPS navigation unit with a map screen, water, routed destination, lower control, and side button", "32": "Dimensional GPS navigation unit with a map screen, water and park cues, routed destination, lower control, and side button" } },
