...
const APPROVED_ICON_SEMANTICS = Object.freeze({
  ...
  "fresh-greens": ["route-map tile with a compact street-block network, one highlighted unbranched three-turn route, distinct route markers, and water and park landmarks", ["road map", "route map", "navigation map"], ["magic wand", "wand", "notebook band", "folded page", "landscape image", "landscape photograph", "groceries", "leaf logo", "city guide", "music note", "musical note", "folded map", "circuit"]],
  understandingfafsa: ["wide folded printed newsprint with a tabloid silhouette, paper depth, a tangible horizontal crease, lower print gutter, and editorial print anatomy", ["newsletter", "printed newsletter", "folded newsletter", "newsprint", "printed newsprint", "newspaper"], ["web page layout", "webpage", "framed web surface", "dashboard", "browser chrome", "browser window", "web application", "app window", "flat screen", "dashboard tile", "open envelope", "letter", "sealed email", "folded map", "mountain", "resume", "folder"]],
...
export const APPROVED_ICON_METADATA = freezeMetadata({
  ...
  "fresh-greens": { group: "projects", tiers: { "16": "Street-block road map with a highlighted three-turn route, distinct endpoint markers, water, and a park", "24": "Street-block route map with a highlighted three-turn route, markers, four parcel cues, water, and a park", "32": "Road-map tile with a street-block network, highlighted three-turn route, distinct markers, four parcel cues, water, and a park" } },
  understandingfafsa: { group: "projects", tiers: { "16": "Wide folded newsprint with a paper stack, segmented masthead, headline, horizontal crease, and lower print gutter", "24": "Wide folded newsprint with rear sheet and shadow, segmented blue masthead, headline, photo, copy columns, horizontal crease, and lower print gutter", "32": "Wide folded newsprint with offset rear sheet and shadow, segmented blue masthead, headline, photo, copy columns, horizontal crease, broad folded lower face, and print gutter" } },
