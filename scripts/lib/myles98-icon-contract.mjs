...
const APPROVED_ICON_SEMANTICS = Object.freeze({
  ...
  email: ["sealed envelope with symmetric closed side folds", ["envelope", "mail", "sealed message"], ["newsletter", "document", "folder"]],
  ...
  "loose-parts": ["literal non-branded compact 2+1 stack of three painted wooden construction cubes with square faces and visible top/right planes", ["building blocks", "construction blocks", "toy blocks"], ["boots", "pair of boots", "people", "group of people", "branded studs", "LEGO", "food", "table", "furniture", "steps", "bar chart", "books", "stack of books", "book stack", "cardboard boxes", "box stack", "logs", "bottle", "clothing"]],
  ...
  "now-playing": ["single blue musical note with warm Myles 98 accents", ["music note", "audio", "now playing"], ["play button", "TikTok logo", "generic app window"]],
  "fresh-greens": ["rugged upright handheld GPS receiver with a separate top antenna, recessed routed map display, rounded cross D-pad, tactile function buttons, and dimensional casing", ["GPS navigator", "navigation device", "route planner"], ["desktop monitor", "computer", "television", "generic app window", "magic wand", "wand", "notebook band", "folded page", "landscape image", "landscape photograph", "groceries", "leaf logo", "city guide", "music note", "musical note", "folded map", "circuit"]],
  understandingfafsa: ["dimensional packet of folded printed newsletters with a visible stacked paper edge, centered vertical crease, lower print gutter, and editorial print anatomy", ["newsletter packet", "printed newsletter", "folded newsletter", "newsprint", "printed newsprint", "newspaper"], ["web page layout", "webpage", "framed web surface", "dashboard", "browser chrome", "browser window", "web application", "app window", "flat screen", "dashboard tile", "open envelope", "letter", "sealed email", "folded map", "mountain", "resume", "folder"]],
  ...
  "tiktok-catalog": ["pixel TikTok note mark with cyan and magenta offsets around a dark musical-note core", ["TikTok logo", "music note", "TikTok mark"], ["shopping bag", "retail bag", "product bag", "wastebasket", "basket", "shopping basket", "small tote", "purse", "catalog page", "floppy disk", "save icon", "diskette", "book", "dashboard"]],
});
...
export const APPROVED_ICON_METADATA = freezeMetadata({
  ...
  email: { group: "system", tiers: { "16": "Sealed envelope", "24": "Sealed envelope with symmetric closed side folds", "32": "Dimensional sealed envelope with symmetric side folds and lower depth band" } },
  ...
  "loose-parts": { group: "personal", tiers: { "16": "Red, yellow, and blue 2+1 construction-cube stack with visible top/right planes", "24": "Red, yellow, and blue 2+1 wooden construction-cube stack with square faces and a restrained upper-cube recess", "32": "Red, yellow, and blue 2+1 wooden construction-cube stack with square faces, visible top/right planes, and a restrained upper-cube recess" } },
  ...
  "now-playing": { group: "system", tiers: { "16": "Compact single music note", "24": "Blue music note with warm accent and pixel depth", "32": "Dimensional single music note with warm Myles 98 accents" } },
  "fresh-greens": { group: "projects", tiers: { "16": "Compact rugged GPS receiver with separate antenna, map display, rounded cross D-pad, and function buttons", "24": "Rugged handheld GPS receiver with separate antenna, recessed routed map, rounded cross D-pad, and function buttons", "32": "Dimensional rugged GPS receiver with separate antenna, recessed map, water and park cues, rounded cross D-pad, and function buttons" } },
  understandingfafsa: { group: "projects", tiers: { "16": "Stacked printed newsletter packet with a masthead, centered fold crease, lower fold, and visible paper edge", "24": "Dimensional newsletter packet with a rear sheet, printed masthead, centered fold crease, headline, photo, copy columns, lower fold, and paper edge", "32": "Dimensional newsletter packet with a thick rear sheet, printed masthead, centered fold crease, headline, photo, copy columns, lower fold, and exposed paper edges" } },
  navi: { group: "projects", tiers: { "16": "Pointed location marker", "24": "Two-plane location marker above a roofed storefront with scalloped awning", "32": "Pointed two-plane marker with orange cue above storefront facade, awning, window, and door" } },
  "tiktok-catalog": { group: "projects", tiers: { "16": "Compact three-channel TikTok note mark", "24": "Stepped TikTok note mark with distinct cyan and magenta offsets", "32": "Large pixel TikTok note mark with distinct cyan and magenta offsets around a dark core" } },
});
