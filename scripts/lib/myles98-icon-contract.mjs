...
const APPROVED_ICON_SEMANTICS = Object.freeze({
  ...
  "tiktok-catalog": ["upright handled shopping bag with a framed opening and a single side depth plane at 24/32", ["shopping bag", "retail bag", "product bag"], ["wastebasket", "basket", "shopping basket", "small tote", "purse", "catalog page", "floppy disk", "save icon", "diskette", "TikTok logo", "music note", "social media app", "book", "dashboard"]],
});
...
export const APPROVED_ICON_METADATA = freezeMetadata({
  ...
  understandingfafsa: { group: "projects", tiers: { "16": "Stacked printed newsletter packet with a masthead, lower fold, and visible paper edge", "24": "Dimensional newsletter packet with a rear sheet, printed masthead, headline, photo, copy columns, lower fold, and paper edge", "32": "Dimensional newsletter packet with a thick rear sheet, printed masthead, headline, photo, copy columns, lower fold, and exposed paper edges" } },
  ...
  "tiktok-catalog": { group: "projects", tiers: { "16": "U-handled upright shopping bag", "24": "U-handled upright shopping bag with framed opening and one side depth plane", "32": "Dimensional U-handled upright shopping bag with framed opening and one side depth plane" } },
});
